...
from fault_models import set_word
...
def hook_mem_unmapped(*args, **kwargs):
    print('\n\n----\n\n')
    print('hook_mem_unmapped')
    print(args)
    print(kwargs)
    print('\n\n++++\n\n')
    return True

def hook_mem_read_invalid(*args, **kwargs):
    print('\n\n----\n\n')
    print('hook_mem_read_invalid')
    print(args)
    print(kwargs)
    print('\n\n++++\n\n')
    # return False

def hook_mem_write_invalid(*args, **kwargs):
    print('\n\n----\n\n')
    print('hook_mem_write_invalid')
    print(args)
    print(kwargs)
    print('\n\n++++\n\n')
    # return False

def hook_mem_fetch_invalid(*args, **kwargs):
    print('\n\n----\n\n')
    print('hook_mem_fetch_invalid')
    print(args)
    print(kwargs)
    print('\n\n++++\n\n')
    # return False

def hook_mem_invalid(*args, **kwargs):
    print('\n\n----\n\n')
...
def main():
    ...
    ql = QilingFi(
        ...
        fi_model=None, fi_args=fi_args,
        md=md
        )

    ql.hook_mem_unmapped(hook_mem_unmapped)
    ql.hook_mem_read_invalid(hook_mem_read_invalid)
    ql.hook_mem_write_invalid(hook_mem_write_invalid)
    ql.hook_mem_fetch_invalid(hook_mem_fetch_invalid)
    ...
    print(f'{addr:x} | {ins[::-1].hex()} | {disasm} | {data} | {exception}')
    # print(f'FREE_BEER: {FREE_BEER} | NO_BEER: {NO_BEER} | EXCEPTION: {EXCEPTION}')
...
if __name__ == "__main__":
    ...
    db = MyDB(
        ...
        "id integer PRIMARY KEY, data text, category int, random text, disasm text, exception text, trace text",
        "id, data, category, random, disasm, exception, trace"
